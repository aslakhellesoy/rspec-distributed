  ...
  module Distributed
    describe RindaConnection do
      ...
      it "should look for an existing ring server" do
        ...
        @mock_service_ts = mock("service_ts")
        Rinda::RingFinger.should_receive(:primary).twice.and_return(@mock_service_ts)
        connect
      end
      ...
      it "should force a lookup if the primary is nil (locally created tuplespace)" do
        ...
        finger = mock("finger")
        finger.should_receive(:lookup_ring_any).and_return(@mock_service_ts)
      ...
      it "should create a ring server if none exists" do
        ...
        Rinda::TupleSpace.should_receive(:new).and_return(@mock_service_ts)
        Rinda::RingServer.should_receive(:new).with(@mock_service_ts)
        connect(true)
      end
